  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="p-4">
          ...
          <CardContent className="p-6">
            <div className="flex items-start">
              <div className="w-16 h-16 bg-primary-200 rounded-full flex items-center justify-center mr-4">
                <span className="text-2xl">{user.type === 'proveedor' ? '🏭' : '🏢'}</span>
              </div>
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900">{user.name}</h2>
                <p className="text-primary-700 font-medium capitalize">{user.type}</p>
        ...
        <Tabs defaultValue={user.type === 'proveedor' ? 'products' : 'orders'} className="w-full">
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold text-gray-900 mb-4">
                  {user.type === 'comerciante' ? 'Mis Pedidos' : 'Pedidos Recibidos'}
                </h3>
          ...
          <TabsContent value="ratings">
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold text-gray-900 mb-4">
                  {user.type === 'comerciante' ? 'Calificaciones Realizadas' : 'Calificaciones Recibidas'}
                </h3>
                <div className="text-center py-8">
                  <span className="text-4xl mb-4 block">⭐</span>
